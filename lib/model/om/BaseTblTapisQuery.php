 ...
 * @method     TblTapisQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 ...
 * @method     TblTapisQuery groupByUpdatedAt() Group by the updated_at column
 ...
 * @method     TblTapis findOneByUpdatedAt(string $updated_at) Return the first TblTapis filtered by the updated_at column
 ...
 * @method     array findByUpdatedAt(string $updated_at) Return TblTapis objects filtered by the updated_at column
...
abstract class BaseTblTapisQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `NUM_TAPIS`, `TAILLE_TAPIS`, `PRIX_METTRE_CARRE`, `MONTANT_LAVAGE_TAPIS`, `DATE_LAVAGE_TAPIS`, `CREATED_AT`, `UPDATED_AT`, `DELETED_AT` FROM `tbl_tapis` WHERE `NUM_TAPIS` = :p0';
		try {
	...
	public function filterByUpdatedAt($updatedAt = null, $comparison = null)
	{
		if (is_array($updatedAt)) {
			...
			if (isset($updatedAt['min'])) {
				$this->addUsingAlias(TblTapisPeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($updatedAt['max'])) {
				$this->addUsingAlias(TblTapisPeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(TblTapisPeer::UPDATED_AT, $updatedAt, $comparison);
	}
