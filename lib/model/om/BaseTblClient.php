...
abstract class BaseTblClient extends BaseObject  implements Persistent
{
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = TblClientPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = TblClientPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setDeletedAt($v)
	{
		...
		if ($this->deleted_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = TblClientPeer::DELETED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 13; // 13 = TblClientPeer::NUM_HYDRATE_COLUMNS.
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if (!empty($ret) && TblClientQuery::isSoftDeleteEnabled()) {
				$this->keepUpdateDateUnchanged();
				$this->setDeletedAt(time());
				$this->save($con);
				$this->postDelete($con);
				$con->commit();
				TblClientPeer::removeInstanceFromPool($this);
				return;
			}
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($this->isModified() && !$this->isColumnModified(TblClientPeer::UPDATED_AT) && !$this->isColumnModified(TblClientPeer::DELETED_AT))
			{
			...
			if ($isInsert) {
				...
				if (!$this->isColumnModified(TblClientPeer::CREATED_AT)) {
					$this->setCreatedAt(time());
				}
				if (!$this->isColumnModified(TblClientPeer::UPDATED_AT)) {
					$this->setUpdatedAt(time());
				}
				// symfony_timestampable behavior
				if (!$this->isColumnModified(TblClientPeer::CREATED_AT))
				...
				// timestampable behavior
				if ($this->isModified() && !$this->isColumnModified(TblClientPeer::UPDATED_AT)) {
					$this->setUpdatedAt(time());
				}
			}
			if ($ret) {
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(TblClientPeer::DELETED_AT)) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TblClientPeer::CREATED_AT)) $criteria->add(TblClientPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(TblClientPeer::UPDATED_AT)) $criteria->add(TblClientPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(TblClientPeer::DELETED_AT)) $criteria->add(TblClientPeer::DELETED_AT, $this->deleted_at);
	...
	{
		if($isSoftDeleteEnabled = TblClientPeer::isSoftDeleteEnabled()) {
			TblClientPeer::disableSoftDelete();
		}
		$this->delete($con);
