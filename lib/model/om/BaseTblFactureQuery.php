...
abstract class BaseTblFactureQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_FACTURE`, `ID_VOITURE`, `ID_EMPLOYE`, `PRIX_LAVAGE`, `COMMENTAIRE_REGLEMENT`, `DATE_REGLEMENT`, `ETAT`, `CREATED_AT`, `DELETED_AT` FROM `tbl_facture` WHERE `ID_FACTURE` = :p0';
		try {
