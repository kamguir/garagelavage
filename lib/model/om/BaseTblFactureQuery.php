 ...
 * @method     TblFactureQuery orderByIdTypeLavage($order = Criteria::ASC) Order by the id_type_lavage column
 ...
 * @method     TblFactureQuery groupByIdTypeLavage() Group by the id_type_lavage column
 ...
 * @method     TblFacture findOneByIdTypeLavage(int $id_type_lavage) Return the first TblFacture filtered by the id_type_lavage column
 ...
 * @method     array findByIdTypeLavage(int $id_type_lavage) Return TblFacture objects filtered by the id_type_lavage column
...
abstract class BaseTblFactureQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_FACTURE`, `ID_VOITURE`, `ID_TYPE_LAVAGE`, `PRIX_LAVAGE`, `COMMENTAIRE_REGLEMENT`, `DATE_REGLEMENT`, `ETAT` FROM `tbl_facture` WHERE `ID_FACTURE` = :p0';
		try {
	...
	{
		if (is_array($idTypeLavage)) {
			$useMinMax = false;
			if (isset($idTypeLavage['min'])) {
				$this->addUsingAlias(TblFacturePeer::ID_TYPE_LAVAGE, $idTypeLavage['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($idTypeLavage['max'])) {
				$this->addUsingAlias(TblFacturePeer::ID_TYPE_LAVAGE, $idTypeLavage['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(TblFacturePeer::ID_TYPE_LAVAGE, $idTypeLavage, $comparison);
	}
