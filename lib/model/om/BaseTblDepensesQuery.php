 ...
 * @method     TblDepensesQuery orderByEtatPayement($order = Criteria::ASC) Order by the etat_payement column
 ...
 * @method     TblDepensesQuery groupByEtatPayement() Group by the etat_payement column
 ...
 * @method     TblDepenses findOneByEtatPayement(boolean $etat_payement) Return the first TblDepenses filtered by the etat_payement column
 ...
 * @method     array findByEtatPayement(boolean $etat_payement) Return TblDepenses objects filtered by the etat_payement column
...
abstract class BaseTblDepensesQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_DEPENSES`, `DATE_DEPENSES`, `ID_REF_DEPENSES`, `MONTANT_DEPENSES`, `ETAT_PAYEMENT`, `CREATED_AT`, `UPDATED_AT`, `DELETED_AT` FROM `tbl_depenses` WHERE `ID_DEPENSES` = :p0';
		try {
	...
	public function filterByEtatPayement($etatPayement = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(TblDepensesPeer::ETAT_PAYEMENT, $etatPayement, $comparison);
	}
	...
	{
		// soft_delete behavior
		if (TblDepensesQuery::isSoftDeleteEnabled() && $this->localSoftDelete) {
			$this->addUsingAlias(TblDepensesPeer::DELETED_AT, null, Criteria::ISNULL);
		} else {
	 ...
	 *
	 * @see TblDepensesQuery::disableSoftDelete() to disable the filter for more than one query
	 *
	 * @return TblDepensesQuery The current query, for fluid interface
	 */
	...
	{
		return TblDepensesPeer::doForceDelete($this, $con);
	}
