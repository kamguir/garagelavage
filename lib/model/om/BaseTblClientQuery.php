 ...
 * @method     TblClientQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 ...
 * @method     TblClientQuery groupByUpdatedAt() Group by the updated_at column
 ...
 * @method     TblClient findOneByUpdatedAt(string $updated_at) Return the first TblClient filtered by the updated_at column
 ...
 * @method     array findByUpdatedAt(string $updated_at) Return TblClient objects filtered by the updated_at column
...
abstract class BaseTblClientQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_CLIENT`, `CIN_CLIENT`, `NOM_CLIENT`, `PRENOM_CLIENT`, `SITUATION`, `AGE_CLIENT`, `NUM_TEL`, `ADRESSE_CLIENT`, `FONCTION_CLIENT`, `IS_EMPLOYE`, `CREATED_AT`, `UPDATED_AT`, `DELETED_AT` FROM `tbl_client` WHERE `ID_CLIENT` = :p0';
		try {
	...
	public function filterByUpdatedAt($updatedAt = null, $comparison = null)
	{
		if (is_array($updatedAt)) {
			...
			if (isset($updatedAt['min'])) {
				$this->addUsingAlias(TblClientPeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($updatedAt['max'])) {
				$this->addUsingAlias(TblClientPeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(TblClientPeer::UPDATED_AT, $updatedAt, $comparison);
	}
	...
	{
		return $this->addUsingAlias(TblClientPeer::UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
	}
	...
	{
		return $this->addUsingAlias(TblClientPeer::CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
	}
	...
	{
		return $this->addDescendingOrderByColumn(TblClientPeer::UPDATED_AT);
	}
	...
	{
		return $this->addAscendingOrderByColumn(TblClientPeer::UPDATED_AT);
	}
	...
	{
		return $this->addDescendingOrderByColumn(TblClientPeer::CREATED_AT);
	}
	...
	{
		return $this->addAscendingOrderByColumn(TblClientPeer::CREATED_AT);
	}
