...
abstract class BaseTblClientQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_CLIENT`, `CIN_CLIENT`, `NOM_CLIENT`, `PRENOM_CLIENT`, `SITUATION`, `AGE_CLIENT`, `NUM_TEL`, `ADRESSE_CLIENT`, `FONCTION_CLIENT`, `IS_EMPLOYE` FROM `tbl_client` WHERE `ID_CLIENT` = :p0';
		try {
