...
abstract class BaseTblDepensesPeer {
	...
	const ETAT_PAYEMENT = 'tbl_depenses.ETAT_PAYEMENT';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('IdDepenses', 'DateDepenses', 'IdRefDepenses', 'MontantDepenses', 'EtatPayement', 'CreatedAt', 'UpdatedAt', 'DeletedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idDepenses', 'dateDepenses', 'idRefDepenses', 'montantDepenses', 'etatPayement', 'createdAt', 'updatedAt', 'deletedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID_DEPENSES, self::DATE_DEPENSES, self::ID_REF_DEPENSES, self::MONTANT_DEPENSES, self::ETAT_PAYEMENT, self::CREATED_AT, self::UPDATED_AT, self::DELETED_AT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID_DEPENSES', 'DATE_DEPENSES', 'ID_REF_DEPENSES', 'MONTANT_DEPENSES', 'ETAT_PAYEMENT', 'CREATED_AT', 'UPDATED_AT', 'DELETED_AT', ),
		BasePeer::TYPE_FIELDNAME => array ('id_depenses', 'date_depenses', 'id_ref_depenses', 'montant_depenses', 'etat_payement', 'created_at', 'updated_at', 'deleted_at', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('IdDepenses' => 0, 'DateDepenses' => 1, 'IdRefDepenses' => 2, 'MontantDepenses' => 3, 'EtatPayement' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, 'DeletedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idDepenses' => 0, 'dateDepenses' => 1, 'idRefDepenses' => 2, 'montantDepenses' => 3, 'etatPayement' => 4, 'createdAt' => 5, 'updatedAt' => 6, 'deletedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID_DEPENSES => 0, self::DATE_DEPENSES => 1, self::ID_REF_DEPENSES => 2, self::MONTANT_DEPENSES => 3, self::ETAT_PAYEMENT => 4, self::CREATED_AT => 5, self::UPDATED_AT => 6, self::DELETED_AT => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID_DEPENSES' => 0, 'DATE_DEPENSES' => 1, 'ID_REF_DEPENSES' => 2, 'MONTANT_DEPENSES' => 3, 'ETAT_PAYEMENT' => 4, 'CREATED_AT' => 5, 'UPDATED_AT' => 6, 'DELETED_AT' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id_depenses' => 0, 'date_depenses' => 1, 'id_ref_depenses' => 2, 'montant_depenses' => 3, 'etat_payement' => 4, 'created_at' => 5, 'updated_at' => 6, 'deleted_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(TblDepensesPeer::ETAT_PAYEMENT);
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		if (TblDepensesQuery::isSoftDeleteEnabled()) {
			$criteria->add(TblDepensesPeer::DELETED_AT, null, Criteria::ISNULL);
		} else {
			TblDepensesPeer::enableSoftDelete();
		}
	...
	{
		TblDepensesQuery::enableSoftDelete();
	...
	{
		TblDepensesQuery::disableSoftDelete();
	}
	...
	{
		return TblDepensesQuery::isSoftDeleteEnabled();
	}
	
	/**
	 * Soft delete records, given a TblDepenses or Criteria object OR a primary key value.
	 *
	 * @param			 mixed $values Criteria or TblDepenses object or primary key or array of primary keys
	 *							which is used to create the DELETE statement
	 * @param			 PropelPDO $con the connection to use
	...
	public static function doSoftDelete($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
	 	...
	 	} elseif ($values instanceof TblDepenses) {
			// create criteria based on pk values
			$selectCriteria = $values->buildPkeyCriteria();
		} else {
			// it must be the primary key
			$selectCriteria = new Criteria(self::DATABASE_NAME);
	 		$selectCriteria->add(TblDepensesPeer::ID_DEPENSES, (array) $values, Criteria::IN);
		}
		// Set the correct dbName
		$selectCriteria->setDbName(TblDepensesPeer::DATABASE_NAME);
		$updateCriteria = new Criteria(self::DATABASE_NAME);
	    $updateCriteria->add(TblDepensesPeer::DELETED_AT, time());
	 	return BasePeer::doUpdate($selectCriteria, $updateCriteria, $con);
	}
	
	/**
	 * Delete or soft delete records, depending on TblDepensesPeer::$softDelete
	 *
	 * @param			 mixed $values Criteria or TblDepenses object or primary key or array of primary keys
	 *							which is used to create the DELETE statement
	 * @param			 PropelPDO $con the connection to use
	...
	{
		if (TblDepensesPeer::isSoftDeleteEnabled()) {
			return TblDepensesPeer::doSoftDelete($values, $con);
		} else {
			return TblDepensesPeer::doForceDelete($values, $con);
		}
	}
	/**
	 * Method to soft delete all rows from the tbl_depenses table.
	 *
	 * @param			 PropelPDO $con the connection to use
	 * @return		 int The number of affected rows (if supported by underlying database driver).
	 * @throws		 PropelException Any exceptions caught during processing will be
	...
	public static function doSoftDeleteAll(PropelPDO $con = null)
	{
		...
		$selectCriteria->add(TblDepensesPeer::DELETED_AT, null, Criteria::ISNULL);
		$selectCriteria->setDbName(TblDepensesPeer::DATABASE_NAME);
		$modifyCriteria = new Criteria();
		$modifyCriteria->add(TblDepensesPeer::DELETED_AT, time());
		return BasePeer::doUpdate($selectCriteria, $modifyCriteria, $con);
	}
	
	/**
	 * Delete or soft delete all records, depending on TblDepensesPeer::$softDelete
	 *
	 * @param			 PropelPDO $con the connection to use
	 * @return		 int	The number of affected rows (if supported by underlying database driver).
	 * @throws		 PropelException Any exceptions caught during processing will be
	...
	{
		if (TblDepensesPeer::isSoftDeleteEnabled()) {
			return TblDepensesPeer::doSoftDeleteAll($con);
		} else {
			return TblDepensesPeer::doForceDeleteAll($con);
		}
	}
