...
abstract class BaseTblDepensesPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('IdDepenses', 'DateDepenses', 'IdRefDepenses', 'MontantDepenses', 'EtatPayement', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idDepenses', 'dateDepenses', 'idRefDepenses', 'montantDepenses', 'etatPayement', ),
		BasePeer::TYPE_COLNAME => array (self::ID_DEPENSES, self::DATE_DEPENSES, self::ID_REF_DEPENSES, self::MONTANT_DEPENSES, self::ETAT_PAYEMENT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID_DEPENSES', 'DATE_DEPENSES', 'ID_REF_DEPENSES', 'MONTANT_DEPENSES', 'ETAT_PAYEMENT', ),
		BasePeer::TYPE_FIELDNAME => array ('id_depenses', 'date_depenses', 'id_ref_depenses', 'montant_depenses', 'etat_payement', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('IdDepenses' => 0, 'DateDepenses' => 1, 'IdRefDepenses' => 2, 'MontantDepenses' => 3, 'EtatPayement' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idDepenses' => 0, 'dateDepenses' => 1, 'idRefDepenses' => 2, 'montantDepenses' => 3, 'etatPayement' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID_DEPENSES => 0, self::DATE_DEPENSES => 1, self::ID_REF_DEPENSES => 2, self::MONTANT_DEPENSES => 3, self::ETAT_PAYEMENT => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID_DEPENSES' => 0, 'DATE_DEPENSES' => 1, 'ID_REF_DEPENSES' => 2, 'MONTANT_DEPENSES' => 3, 'ETAT_PAYEMENT' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id_depenses' => 0, 'date_depenses' => 1, 'id_ref_depenses' => 2, 'montant_depenses' => 3, 'etat_payement' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
