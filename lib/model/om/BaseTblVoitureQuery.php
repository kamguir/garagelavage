 ...
 * @method     TblVoitureQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method     TblVoitureQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 * @method     TblVoitureQuery orderByDeletedAt($order = Criteria::ASC) Order by the deleted_at column
 *
 ...
 * @method     TblVoitureQuery groupByCreatedAt() Group by the created_at column
 * @method     TblVoitureQuery groupByUpdatedAt() Group by the updated_at column
 * @method     TblVoitureQuery groupByDeletedAt() Group by the deleted_at column
 *
 ...
 * @method     TblVoiture findOneByCreatedAt(string $created_at) Return the first TblVoiture filtered by the created_at column
 * @method     TblVoiture findOneByUpdatedAt(string $updated_at) Return the first TblVoiture filtered by the updated_at column
 * @method     TblVoiture findOneByDeletedAt(string $deleted_at) Return the first TblVoiture filtered by the deleted_at column
 *
 ...
 * @method     array findByCreatedAt(string $created_at) Return TblVoiture objects filtered by the created_at column
 * @method     array findByUpdatedAt(string $updated_at) Return TblVoiture objects filtered by the updated_at column
 * @method     array findByDeletedAt(string $deleted_at) Return TblVoiture objects filtered by the deleted_at column
 *
...
abstract class BaseTblVoitureQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_VOITURE`, `ID_CLIENT`, `IMMATRICULATION`, `ID_MARQUE`, `ID_MOTORISATION`, `COULEUR`, `NBR_PORTES`, `MODELE`, `ANNEE`, `NB_VISITE`, `CREATED_AT`, `UPDATED_AT`, `DELETED_AT` FROM `tbl_voiture` WHERE `ID_VOITURE` = :p0';
		try {
	...
	public function filterByCreatedAt($createdAt = null, $comparison = null)
	{
		if (is_array($createdAt)) {
			...
			if (isset($createdAt['min'])) {
				$this->addUsingAlias(TblVoiturePeer::CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($createdAt['max'])) {
				$this->addUsingAlias(TblVoiturePeer::CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(TblVoiturePeer::CREATED_AT, $createdAt, $comparison);
	}
	...
	public function filterByUpdatedAt($updatedAt = null, $comparison = null)
	{
		if (is_array($updatedAt)) {
			...
			if (isset($updatedAt['min'])) {
				$this->addUsingAlias(TblVoiturePeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($updatedAt['max'])) {
				$this->addUsingAlias(TblVoiturePeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(TblVoiturePeer::UPDATED_AT, $updatedAt, $comparison);
	}
	...
	public function filterByDeletedAt($deletedAt = null, $comparison = null)
	{
		if (is_array($deletedAt)) {
			...
			if (isset($deletedAt['min'])) {
				$this->addUsingAlias(TblVoiturePeer::DELETED_AT, $deletedAt['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($deletedAt['max'])) {
				$this->addUsingAlias(TblVoiturePeer::DELETED_AT, $deletedAt['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(TblVoiturePeer::DELETED_AT, $deletedAt, $comparison);
	}
	...
	{
		// soft_delete behavior
		if (TblVoitureQuery::isSoftDeleteEnabled() && $this->localSoftDelete) {
			$this->addUsingAlias(TblVoiturePeer::DELETED_AT, null, Criteria::ISNULL);
		} else {
	 ...
	 *
	 * @see TblVoitureQuery::disableSoftDelete() to disable the filter for more than one query
	 *
	 * @return TblVoitureQuery The current query, for fluid interface
	 */
	...
	{
		return TblVoiturePeer::doForceDelete($this, $con);
	}
