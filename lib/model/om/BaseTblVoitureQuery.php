...
abstract class BaseTblVoitureQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_VOITURE`, `ID_CLIENT`, `IMMATRICULATION`, `ID_MARQUE`, `ID_MOTORISATION`, `COULEUR`, `NBR_PORTES`, `MODELE`, `ANNEE`, `NB_VISITE`, `CREATED_AT`, `DELETED_AT` FROM `tbl_voiture` WHERE `ID_VOITURE` = :p0';
		try {
