...
abstract class BaseTblTapis extends BaseObject  implements Persistent
{
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = TblTapisPeer::CREATED_AT;
			}
		} // if either are not null
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = TblTapisPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setDeletedAt($v)
	{
		...
		if ($this->deleted_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = TblTapisPeer::DELETED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 8; // 8 = TblTapisPeer::NUM_HYDRATE_COLUMNS.
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if (!empty($ret) && TblTapisQuery::isSoftDeleteEnabled()) {
				$this->setDeletedAt(time());
				$this->save($con);
				$this->postDelete($con);
				$con->commit();
				TblTapisPeer::removeInstanceFromPool($this);
				return;
			}
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($this->isModified() && !$this->isColumnModified(TblTapisPeer::UPDATED_AT) && !$this->isColumnModified(TblTapisPeer::DELETED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(TblTapisPeer::CREATED_AT))
				{
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(TblTapisPeer::UPDATED_AT)) {
			$modifiedColumns[':p' . $index++]  = '`UPDATED_AT`';
		}
		if ($this->isColumnModified(TblTapisPeer::DELETED_AT)) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TblTapisPeer::CREATED_AT)) $criteria->add(TblTapisPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(TblTapisPeer::UPDATED_AT)) $criteria->add(TblTapisPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(TblTapisPeer::DELETED_AT)) $criteria->add(TblTapisPeer::DELETED_AT, $this->deleted_at);
	...
	{
		if($isSoftDeleteEnabled = TblTapisPeer::isSoftDeleteEnabled()) {
			TblTapisPeer::disableSoftDelete();
		}
		$this->delete($con);
