...
abstract class BaseTblDepenses extends BaseObject  implements Persistent
{
	...
	public function setEtatPayement($v)
	{
		...
		if ($this->etat_payement !== $v) {
			...
			$this->modifiedColumns[] = TblDepensesPeer::ETAT_PAYEMENT;
		}
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if (!empty($ret) && TblDepensesQuery::isSoftDeleteEnabled()) {
				$this->setDeletedAt(time());
				$this->save($con);
				$this->postDelete($con);
				$con->commit();
				TblDepensesPeer::removeInstanceFromPool($this);
				return;
			}
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($this->isModified() && !$this->isColumnModified(TblDepensesPeer::UPDATED_AT) && !$this->isColumnModified(TblDepensesPeer::DELETED_AT))
			{
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(TblDepensesPeer::ETAT_PAYEMENT)) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TblDepensesPeer::ETAT_PAYEMENT)) $criteria->add(TblDepensesPeer::ETAT_PAYEMENT, $this->etat_payement);
	...
	{
		if($isSoftDeleteEnabled = TblDepensesPeer::isSoftDeleteEnabled()) {
			TblDepensesPeer::disableSoftDelete();
		}
		$this->delete($con);
