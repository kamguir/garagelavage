 ...
 *
 * @method     RefSituationQuery leftJoinTblClient($relationAlias = null) Adds a LEFT JOIN clause to the query using the TblClient relation
 * @method     RefSituationQuery rightJoinTblClient($relationAlias = null) Adds a RIGHT JOIN clause to the query using the TblClient relation
 * @method     RefSituationQuery innerJoinTblClient($relationAlias = null) Adds a INNER JOIN clause to the query using the TblClient relation
 *
...
abstract class BaseRefSituationQuery extends ModelCriteria
{
	 ...
	 *
	 * @param     TblClient $tblClient  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    RefSituationQuery The current query, for fluid interface
	 */
	public function filterByTblClient($tblClient, $comparison = null)
	{
		if ($tblClient instanceof TblClient) {
			return $this
				->addUsingAlias(RefSituationPeer::ID_SITUATION, $tblClient->getSituation(), $comparison);
		} elseif ($tblClient instanceof PropelCollection) {
			return $this
				->useTblClientQuery()
				->filterByPrimaryKeys($tblClient->getPrimaryKeys())
				->endUse();
		} else {
