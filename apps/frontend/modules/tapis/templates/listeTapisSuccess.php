<div class="container" style="width: 100%;">
    <h3 style="font-size: 20px; border-bottom: 1px solid #ddd;" >Liste des Tapis</h3>
    </br>
    ...
    <div class=" entitefiltre fg-toolbar ui-toolbar ui-widget-header ui-corner-bl ui-corner-br ui-corner-tl ui-corner-tr ui-helper-clearfix">
        <form method="POST" action="<?php echo url_for("tapis/listeTapis") ?>">        
            <?php // echo $formFilter ?>        
        </form>
    </div>

    <div>
        <table cellpadding="0" cellspacing="0" border="0" id="listeTapis" class="display" style="cursor: pointer;">
            <thead>
                <tr>
                    <!--<th><?php // echo __('CIN') ?></th>-->
                    <th><?php echo __('Num Tapis') ?></th>
                    <th><?php echo __('Taille') ?></th>
                    <th><?php echo __('Montant') ?></th>
                    <th><?php echo __('Date Lavage') ?></th>
                </tr>
            </thead>
            <tbody>
...
//            "bStateSave": true,
                    ...
                    "sAjaxSource": '<?php echo url_for('tapis/listeTapisAjax') ?>',
            ...
            $("#listeTapis .even,#listeTapis .odd").live("click",function(){
            window.location = "<?php echo url_for("tapis/edit?num_tapis=") ?>"+$(this).attr("id").substring(4);
        });
    });
</script>
